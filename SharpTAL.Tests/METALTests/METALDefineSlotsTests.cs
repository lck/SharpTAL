...
namespace SharpTAL.SharpTALTests.METALTests
{
	...
	public class METALDefineSlotsTests
	{
		...
		{
			RunTest(@"<html><div metal:define-macro=""one"" class=""funny"">Before <b metal:define-slot=""blue"">blue</b> After</div></html>",
		...
		{
			RunTest(@"<html><div metal:define-macro=""one"" class=""funny"">Before <b metal:define-slot=""blue"">blue</b> After <a metal:define-slot=""red"">red</a></div></html>",
		...
		{
			RunTest(@"<html><p metal:define-macro=""two"">Internal macro, colour blue: <b metal:define-slot=""blue"">blue</b></p><div metal:define-macro=""one"" class=""funny"">Before <b metal:define-slot=""blue"">blue</b> After <a metal:use-macro='site.macros[""two""]'>Internal</a></div></html>",
		...
		{
			RunTest(@"<html><p metal:define-macro=""two"">Internal macro, colour blue: <b metal:define-slot=""blue"">blue</b></p><div metal:define-macro=""one"" class=""funny"">Before <b metal:define-slot=""blue"">blue</b> After <a metal:use-macro='site.macros[""two""]'>Internal<p metal:fill-slot=""blue"">pink!</p></a> finally outer blue again: <a metal:define-slot=""blue"">blue goes here</a></div></html>",
				@"<html><body metal:use-macro='site.macros[""one""]'>Nowt <i metal:fill-slot=""blue"">white</i></body></html>",
		...
		{
			RunTest(@"<html><div metal:define-macro=""one"" class=""funny"">Before <b metal:define-slot=""blue"" tal:content=""test"">blue</b> After</div></html>",
